...
const Alerts = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-gray-800">Sistema de Alertas</h1>

      {/* Envío manual de alertas */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Envío Manual de Alertas</h2>
        ...
        <div className="space-x-4">
          <button
            ...
            disabled={loading}
            className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg font-semibold transition duration-200 disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition duration-200 disabled:opacity-50"
          >
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Alertas Automáticas</h2>
        <p className="text-gray-600 mb-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            ...
            />
            <label htmlFor="enableAlerts" className="text-gray-700 font-medium">
              Activar alertas automáticas
            </label>
          </div>

          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-medium text-blue-800 mb-2">⏰ Horarios programados:</h3>
          ...
          <button
            ...
            disabled={loading}
            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition duration-200 disabled:opacity-50"
          >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-blue-800 mb-2">📋 Configuración de Email</h3>
        <p className="text-blue-700 mb-3">
          Para que las alertas funcionen correctamente, asegúrate de configurar las variables de entorno de email:
        </p>
        <ul className="text-blue-700 text-sm space-y-1">
          <li>• <code className="bg-blue-100 px-1 rounded">EMAIL_HOST</code> - Servidor SMTP (ej: smtp.gmail.com)</li>
          <li>• <code className="bg-blue-100 px-1 rounded">EMAIL_PORT</code> - Puerto SMTP (ej: 587)</li>
          <li>• <code className="bg-blue-100 px-1 rounded">EMAIL_USER</code> - Usuario de email</li>
          <li>• <code className="bg-blue-100 px-1 rounded">EMAIL_PASS</code> - Contraseña de aplicación</li>
        </ul>
      </div>
    </div>
  );
